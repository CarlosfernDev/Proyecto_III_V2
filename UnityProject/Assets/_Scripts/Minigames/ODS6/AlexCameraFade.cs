...
public class AlexCameraFade : MonoBehaviour
{
    static private AlexCameraFade instance;
    static public AlexCameraFade Instance
    {
        get
        {
            if (instance == null)
                instance = GameObject.FindObjectOfType<AlexCameraFade>();
